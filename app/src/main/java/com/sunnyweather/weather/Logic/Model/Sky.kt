...
private val sky= mapOf(
    "CLEAR_DAY" to Sky("睛",R.drawable.ic_clear_day, R.drawable.bg_clear_day),
    "CLEAR_NIGHT" to Sky("睛",R.drawable.ic_clear_night, R.drawable.bg_clear_night),
...
"HEAVY" to Sky("大雨", R.drawable.ic_heavy_rain, R.drawable.bg_rain),
